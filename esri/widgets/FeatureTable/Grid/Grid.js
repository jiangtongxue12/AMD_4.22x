...
//>>built
define("../../../chunks/_rollupPluginBabelHelpers ../../../chunks/tslib.es6 ../../../core/Collection ../../../core/events ../../../core/HandleOwner ../../../core/maybe ../../../core/watchUtils ../../../core/accessorSupport/decorators/aliasOf ../../../core/arrayUtils ../../../core/has ../../../core/accessorSupport/decorators/cast ../../../core/accessorSupport/decorators/property ../../../core/accessorSupport/decorators/subclass ../../Widget ./GridViewModel ../../support/widgetUtils ../../support/decorators/messageBundle ../../../core/Logger ../../support/jsxFactory".split(" "),
function($b,x,Zd,ac,$d,ae,eb,H,og,pg,be,V,ce,de,ee,fe,ge,qg,ja){function bc(b){requestAnimationFrame(function(){cc?cc(b):(fb||(fb=new Promise(a=>{gb=a}),"complete"===document.readyState?gb():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&gb()})),fb.then(function(){b&&b()}))})}function hb(b,a){for(let c in a)null===c?b.style.removeProperty(c):b.style.setProperty(c,a[c])}function dc(b,a){return(b=window.getComputedStyle(b).getPropertyValue(a))?b.trim():""}function ec(b){ib=
...
return this._styleSheet}toString(){return this.cssText}}const Ba=(b,...a)=>{a=a.reduce((c,d,e)=>{if(d instanceof Mb)d=d.cssText;else if("number"!==typeof d)throw Error(`Value passed to 'css' function must be a 'css' function result: ${d}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`);return c+d+b[e+1]},b[0]);return new Mb(a,kd)};(window.litElementVersions||(window.litElementVersions=[])).push("2.5.0");let ld=0;const Nb={},Ca=(b,a,c)=>{const d=c&&
c.moduleId||`custom-style-module-${ld++}`;Array.isArray(a)||(a=a?[a]:[]);a.forEach(f=>{if(!(f instanceof Mb))throw Error("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`.");if(!Nb[f]){const g=document.createElement("dom-module");g.innerHTML=`\n        <template>\n          <style>${f.toString()}</style>\n        </template>\n      `;const h=`custom-style-module-${ld++}`;g.register(h);Nb[f]=h}});const e=document.createElement("dom-module");if(b){const f=window.customElements&&
window.customElements.get(b);f&&f.hasOwnProperty("__finalized")&&console.warn(`The custom element definition for "${b}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`);e.setAttribute("theme-for",b)}e.innerHTML=`\n    <template>\n      ${(c&&c.include||[]).map(f=>`<style include=${f}></style>`)}\n      ${a.map(f=>`<style include=${Nb[f]}></style>`)}\n    </template>\n  `;
...
Ya=D(b=>{const a=qf(rd(b));class c extends a{constructor(){super();this.__isPropertyEffectsClient=!0;this.__dataClientsReady;this.__dataPendingClients;this.__dataToNotify;this.__dataLinkedPaths;this.__dataHasPaths;this.__dataCompoundStorage;this.__dataHost;this.__dataTemp;this.__dataClientsInitialized;this.__data;this.__dataPending;this.__dataOld;this.__computeEffects;this.__computeInfo;this.__reflectEffects;this.__notifyEffects;this.__propagateEffects;this.__observeEffects;this.__readOnly;this.__templateInfo;
this._overrideLegacyUndefined}get PROPERTY_EFFECT_TYPES(){return t}_initializeProperties(){super._initializeProperties();this._registerHost();this.__dataClientsReady=!1;this.__dataLinkedPaths=this.__dataToNotify=this.__dataPendingClients=null;this.__dataHasPaths=!1;this.__dataCompoundStorage=this.__dataCompoundStorage||null;this.__dataHost=this.__dataHost||null;this.__dataTemp={};this.__dataClientsInitialized=!1}_registerHost(){if(Da.length){let d=Da[Da.length-1];d._enqueueClient(this);this.__dataHost=
d}}_initializeProtoProperties(d){this.__data=Object.create(d);this.__dataPending=Object.create(d);this.__dataOld={}}_initializeInstanceProperties(d){let e=this[t.READ_ONLY];for(let f in d)e&&e[f]||(this.__dataPending=this.__dataPending||{},this.__dataOld=this.__dataOld||{},this.__data[f]=this.__dataPending[f]=d[f])}_addPropertyEffect(d,e,f){this._createPropertyAccessor(d,e==t.READ_ONLY);let g=nb(this,e,!0)[d];g||(g=this[e][d]=[]);g.push(f)}_removePropertyEffect(d,e,f){d=nb(this,e,!0)[d];f=d.indexOf(f);
...
e){for(let f in d)!e&&this[t.READ_ONLY]&&this[t.READ_ONLY][f]||this._setPendingPropertyOrPath(f,d[f],!0);this._invalidateProperties()}ready(){this._flushProperties();this.__dataClientsReady||this._flushClients();this.__dataPending&&this._flushProperties()}_propertiesChanged(d,e,f){d=this.__dataHasPaths;this.__dataHasPaths=!1;var g;if(g=this[t.COMPUTE])if(ff){na++;var h=re(this),k=[];for(var l in e)ud(l,g,k,h,d);for(;l=k.shift();)mc(this,"",e,f,l)&&ud(l.methodInfo,g,k,h,d);Object.assign(f,this.__dataOld);
Object.assign(e,this.__dataPending);this.__dataPending=null}else for(h=e;ma(this,g,h,f,d);)Object.assign(f,this.__dataOld),Object.assign(e,this.__dataPending),h=this.__dataPending,this.__dataPending=null;g=this.__dataToNotify;this.__dataToNotify=null;this._propagatePropertyChanges(e,f,d);this._flushClients();ma(this,this[t.REFLECT],e,f,d);ma(this,this[t.OBSERVE],e,f,d);if(g){{h=this[t.NOTIFY];let z;k=na++;for(let P in g)if(g[P]){if(l=h){{var m=h;l=k;var n=P,p=e,r=f,u=d;let wd=!1,sf=u?I(n):n;if(m=
m[sf])for(let Pb=0,tf=m.length,Q;Pb<tf&&(Q=m[Pb]);Pb++)Q.info&&Q.info.lastRun===l||u&&!ob(n,Q.trigger)||(Q.info&&(Q.info.lastRun=l),Q.fn(this,n,p,r,Q.info,u,void 0),wd=!0);l=wd}}if(l)z=!0;else{if(l=d)l=P,n=e,p=I(l),p!==l?(p=La(p)+"-changed",lc(this,p,n[l],l),l=!0):l=!1;l&&(z=!0)}}let E;z&&(E=this.__dataHost)&&E._invalidateProperties&&E._invalidateProperties()}}1==this.__dataCounter&&(this.__dataTemp={})}_propagatePropertyChanges(d,e,f){this[t.PROPAGATE]&&ma(this,this[t.PROPAGATE],d,e,f);this.__templateInfo&&
this._runEffectsForTemplate(this.__templateInfo,d,e,f)}_runEffectsForTemplate(d,e,f,g){const h=(k,l)=>{ma(this,d.propertyEffects,k,f,l,d.nodeList);for(let m=d.firstChild;m;m=m.nextSibling)this._runEffectsForTemplate(m,k,f,l)};d.runEffects?d.runEffects(h,e,g):h(e,g)}linkPaths(d,e){d=la(d);e=la(e);this.__dataLinkedPaths=this.__dataLinkedPaths||{};this.__dataLinkedPaths[d]=e}unlinkPaths(d){d=la(d);this.__dataLinkedPaths&&delete this.__dataLinkedPaths[d]}notifySplices(d,e){let f={path:""};d=A(this,d,
f);rc(this,d,f.path,e)}get(d,e){return A(e||this,d)}set(d,e,f){f?hc(f,d,e):this[t.READ_ONLY]&&this[t.READ_ONLY][d]||this._setPendingPropertyOrPath(d,e,!0)&&this._invalidateProperties()}push(d,...e){let f={path:""};d=A(this,d,f);let g=d.length,h=d.push(...e);e.length&&pa(this,d,f.path,g,e.length,[]);return h}pop(d){let e={path:""};d=A(this,d,e);let f=!!d.length,g=d.pop();f&&pa(this,d,e.path,d.length,0,[g]);return g}splice(d,e,f,...g){let h={path:""},k=A(this,d,h);0>e?e=k.length-Math.floor(-e):e&&(e=
Math.floor(e));let l;l=2===arguments.length?k.splice(e):k.splice(e,f,...g);(g.length||l.length)&&pa(this,k,h.path,e,g.length,l);return l}shift(d){let e={path:""};d=A(this,d,e);let f=!!d.length,g=d.shift();f&&pa(this,d,e.path,0,0,[g]);return g}unshift(d,...e){let f={path:""};d=A(this,d,f);let g=d.unshift(...e);e.length&&pa(this,d,f.path,0,e.length,[]);return g}notifyPath(d,e){if(1==arguments.length){var f={path:""};e=A(this,d,f);f=f.path}else f=Array.isArray(d)?la(d):d;this._setPendingPropertyOrPath(f,
e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(d,e){this._addPropertyEffect(d,t.READ_ONLY);e&&(this["_set"+xe(d)]=function(f){this._setProperty(d,f)})}_createPropertyObserver(d,e,f){let g={property:d,method:e,dynamicFn:!!f};this._addPropertyEffect(d,t.OBSERVE,{fn:kc,info:g,trigger:{name:d}});f&&this._addPropertyEffect(e,t.OBSERVE,{fn:kc,info:g,trigger:{name:e}})}_createMethodObserver(d,e){let f=rb(d);if(!f)throw Error("Malformed observer expression '"+d+"'");oc(this,f,t.OBSERVE,pb,
null,e)}_createNotifyingProperty(d){this._addPropertyEffect(d,t.NOTIFY,{fn:pe,info:{eventName:La(d)+"-changed",property:d}})}_createReflectedProperty(d){let e=this.constructor.attributeNameForProperty(d);"-"===e[0]?console.warn("Property "+d+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(d,t.REFLECT,{fn:qe,info:{attrName:e}})}_createComputedProperty(d,e,f){let g=rb(e);if(!g)throw Error("Malformed computed expression '"+
e+"'");e=oc(this,g,t.COMPUTE,mc,d,f);nb(this,"__computeInfo")[d]=e}_marshalArgs(d,e,f){const g=this.__data,h=[];for(let k=0,l=d.length;k<l;k++){let {name:m,structured:n,wildcard:p,value:r,literal:u}=d[k];if(!u)if(p){const z=0===e.indexOf(m+"."),E=qc(g,f,z?e:m);r={path:z?e:m,value:E,base:z?A(g,m):E}}else r=n?qc(g,f,m):g[m];if(sb&&!this._overrideLegacyUndefined&&void 0===r&&1<d.length)return oa;h[k]=r}return h}static addPropertyEffect(d,e,f){this.prototype._addPropertyEffect(d,e,f)}static createPropertyObserver(d,
...
d.propertyEffects||{};(d[e]=d[e]||[]).push(f)}_stampTemplate(d,e){e=e||this._bindTemplate(d,!0);Da.push(this);d=super._stampTemplate(d,e);Da.pop();e.nodeList=d.nodeList;if(!e.wasPreBound){var f=e.childNodes=[];for(var g=d.firstChild;g;g=g.nextSibling)f.push(g)}d.templateInfo=e;{let {nodeList:k,nodeInfoList:l}=e;if(l.length)for(let m=0;m<l.length;m++){let n=k[m],p=l[m].bindings;if(p)for(let r=0;r<p.length;r++){let u=p[r];f=n;g=u;if(g.isCompound){let z=f.__dataCompoundStorage||(f.__dataCompoundStorage=
{});var h=g.parts;let E=Array(h.length);for(let P=0;P<h.length;P++)E[P]=h[P].literal;h=g.target;z[h]=E;g.literal&&"property"==g.kind&&("className"===h&&(f=q(f)),f[h]=g.literal)}ue(n,this,u)}n.__dataHost=this}}this.__dataClientsReady&&(this._runEffectsForTemplate(e,this.__data,null,!1),this._flushClients());return d}_removeBoundDom(d){d=d.templateInfo;const {previousSibling:e,nextSibling:f,parent:g}=d;e?e.nextSibling=f:g&&(g.firstChild=f);f?f.previousSibling=e:g&&(g.lastChild=e);d.nextSibling=d.previousSibling=
null;d=d.childNodes;for(let h=0;h<d.length;h++){let k=d[h];q(q(k).parentNode).removeChild(k)}}static _parseTemplateNode(d,e,f){let g=a._parseTemplateNode.call(this,d,e,f);if(d.nodeType===Node.TEXT_NODE){let h=this._parseBindings(d.textContent,e);h&&(d.textContent=pc(h)||" ",qb(this,e,f,"text","textContent",h),g=!0)}return g}static _parseTemplateNodeAttribute(d,e,f,g,h){let k=this._parseBindings(h,e);if(k){h=g;let l="property";rf.test(g)?l="attribute":"$"==g[g.length-1]&&(g=g.slice(0,-1),l="attribute");
let m=pc(k);m&&"attribute"==l&&("class"==g&&d.hasAttribute("class")&&(m+=" "+d.getAttribute(g)),d.setAttribute(g,m));"attribute"==l&&"disable-upgrade$"==h&&d.setAttribute(g,"");"input"===d.localName&&"value"===h&&d.setAttribute(h,"");d.removeAttribute(h);"property"===l&&(g=ic(g));qb(this,e,f,l,g,k,m);return!0}return a._parseTemplateNodeAttribute.call(this,d,e,f,g,h)}static _parseTemplateNestedTemplate(d,e,f){let g=a._parseTemplateNestedTemplate.call(this,d,e,f);const h=d.parentNode,k=f.templateInfo,
l="dom-if"===h.localName,m="dom-repeat"===h.localName;cd&&(l||m)&&(h.removeChild(d),f=f.parentInfo,f.templateInfo=k,f.noted=!0,g=!1);d=k.hostProps;if(dd&&l)d&&(e.hostProps=Object.assign(e.hostProps||{},d),cd||(f.parentInfo.noted=!0));else for(let n in d)qb(this,e,f,"property","_host_"+n,[{mode:"{",source:n,dependencies:[n],hostProp:!0}]);return g}static _parseBindings(d,e){let f=[];for(var g=0,h;null!==(h=vd.exec(d));){h.index>g&&f.push({literal:d.slice(g,h.index)});g=h[1][0];let m=!!h[2];h=h[3].trim();
let n=!1,p="";var k=-1;"{"==g&&0<(k=h.indexOf("::"))&&(p=h.substring(k+2),h=h.substring(0,k),n=!0);k=rb(h);let r=[];if(k){let {args:u,methodName:z}=k;for(var l=0;l<u.length;l++){let E=u[l];E.literal||r.push(E)}if((l=e.dynamicFns)&&l[z]||k.static)r.push(z),k.dynamicFn=!0}else r.push(h);f.push({source:h,mode:g,negate:m,customEvent:n,signature:k,dependencies:r,event:p});g=vd.lastIndex}g&&g<d.length&&(d=d.substring(g))&&f.push({literal:d});return f.length?f:null}static _evaluateBinding(d,e,f,g,h,k){d=
e.signature?pb(d,f,g,h,e.signature):f!=e.source?A(d,e.source):k&&0<=f.indexOf(".")?A(d,f):d.__data[f];e.negate&&(d=!d);return d}}return c}),Da=[],uf=D(b=>{function a(e){e=Object.getPrototypeOf(e);return e.prototype instanceof d?e:null}function c(e){if(!e.hasOwnProperty("__ownProperties")){var f=null;if(e.hasOwnProperty("properties")){var g=e.properties;if(g){f=g;g={};for(let h in f){const k=f[h];g[h]="function"===typeof k?{type:k}:k}f=g}}e.__ownProperties=f}return e.__ownProperties}b=pd(b);class d extends b{static get observedAttributes(){if(!this.hasOwnProperty("__observedAttributes")){const e=
...
this._properties[e])&&e.type}_initializeProperties(){this.constructor.finalize();super._initializeProperties()}connectedCallback(){super.connectedCallback&&super.connectedCallback();this._enableProperties()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback()}}return d}),Qb=window.ShadyCSS&&window.ShadyCSS.cssBuild,Za=D(b=>{function a(e,f,g,h){if(!Qb){const p=f.content.querySelectorAll("style"),r=mb(f);var k=le(g),l=f.content.firstElementChild;for(var m=0;m<k.length;m++){var n=
k[m];n.textContent=e._processStyleText(n.textContent,h);f.content.insertBefore(n,l)}k=0;for(l=0;l<r.length;l++)m=r[l],n=p[k],n!==m?(m=m.cloneNode(!0),n.parentNode.insertBefore(m,n)):k++,m.textContent=e._processStyleText(m.textContent,h)}window.ShadyCSS&&window.ShadyCSS.prepareTemplate(f,g);if(gf&&Qb&&bf&&(f=f.content.querySelectorAll("style"))){let p="";Array.from(f).forEach(r=>{p+=r.textContent;r.parentNode.removeChild(r)});e._styleSheet=new CSSStyleSheet;e._styleSheet.replaceSync(p)}}const c=uf(Ya(b));
class d extends c{static get polymerElementVersion(){return"3.4.1"}static _finalizeClass(){c._finalizeClass.call(this);var e;this.hasOwnProperty("__ownObservers")||(this.__ownObservers=this.hasOwnProperty("observers")?this.observers:null);(e=this.__ownObservers)&&this.createObservers(e,this._properties);this._prepareTemplate()}static _prepareTemplate(){let e=this.template;e&&("string"===typeof e?(console.error("template getter must return HTMLTemplateElement"),e=null):xa||(e=e.cloneNode(!0)));this.prototype._template=
...
this.prototype.hasOwnProperty("_template")?this.prototype._template:void 0;if(void 0===e){if(e=this.hasOwnProperty("is")){{e=this.is;let f=null;if(e&&(!ba||df)&&(f=L.import(e,"template"),ba&&!f))throw Error(`strictTemplatePolicy: expecting dom-module or null template for ${e}`);e=f}}e=e||Object.getPrototypeOf(this.prototype).constructor.template}this._template=e}return this._template}static set template(e){this._template=e}static get importPath(){if(!this.hasOwnProperty("_importPath")){var e=this.importMeta;
this._importPath=e?kb(e.url):(e=L.import(this.is))&&e.assetpath||Object.getPrototypeOf(this.prototype).constructor.importPath}return this._importPath}constructor(){super();this._template;this._importPath;this.rootPath;this.importPath;this.root;this.$}_initializeProperties(){this.constructor.finalize();this.constructor._finalizeTemplate(this.localName);super._initializeProperties();this.rootPath=cf;this.importPath=this.constructor.importPath;var e=this.constructor;if(!e.hasOwnProperty("__propertyDefaults")){e.__propertyDefaults=
...
if(f&&!f.__polymerFinalized){f.__polymerFinalized=!0;var g=this.importPath;g=g?ka(g):"";a(this,f,e,g);this.prototype._bindTemplate(f)}}connectedCallback(){window.ShadyCSS&&this._template&&window.ShadyCSS.styleElement(this);super.connectedCallback()}ready(){this._template&&(this.root=this._stampTemplate(this._template),this.$=this.root.$);super.ready()}_readyClients(){this._template&&(this.root=this._attachDom(this.root));super._readyClients()}_attachDom(e){const f=q(this);if(f.attachShadow)return e?
(f.shadowRoot||(f.attachShadow({mode:"open",shadyUpgradeFragment:e}),f.shadowRoot.appendChild(e),this.constructor._styleSheet&&(f.shadowRoot.adoptedStyleSheets=[this.constructor._styleSheet])),ef&&window.ShadyDOM&&window.ShadyDOM.flushInitial(f.shadowRoot),f.shadowRoot):null;throw Error("ShadowDOM not available. PolymerElement can create dom as children instead of in ShadowDOM by setting `this.root \x3d this;` before `ready`.");}updateStyles(e){window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,e)}resolveUrl(e,
f){!f&&this.importPath&&(f=ka(this.importPath));return ka(e,f)}static _parseTemplateContent(e,f,g){f.dynamicFns=f.dynamicFns||this._properties;return c._parseTemplateContent.call(this,e,f,g)}static _addTemplatePropertyEffect(e,f,g){!$c||f in this._properties||g.info.part.signature&&g.info.part.signature.static||g.info.part.hostProp||e.nestedTemplate||console.warn(`Property '${f}' used in template but not declared in 'properties'; `+"attribute will not be observed.");return c._addTemplatePropertyEffect.call(this,
e,f,g)}}return d}),Ea=function(b,...a){const c=document.createElement("template");c.innerHTML=a.reduce((d,e,f)=>{if(e instanceof HTMLTemplateElement)e=e.innerHTML;else throw Error(`non-template value passed to Polymer's html function: ${e}`);return d+e+b[f+1]},b[0]);return c},R=Za(HTMLElement);class v{constructor(){this._timer=this._callback=this._asyncModule=null}setConfig(b,a){this._asyncModule=b;this._callback=a;this._timer=this._asyncModule.run(()=>{this._timer=null;S.delete(this);this._callback()})}cancel(){this.isActive()&&
(this._cancelAsync(),S.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(b,a,c){b instanceof v?b._cancelAsync():b=new v;b.setConfig(a,c);return b}}let S=new Set;const vf=function(){const b=!!S.size;S.forEach(a=>{try{a.flush()}catch(c){setTimeout(()=>{throw c;})}});return b};let tb="string"===typeof document.head.style.touchAction,Na=["mousedown",
"mousemove","mouseup","click"],Ae=[0,1,4,2];try{var xd=1===(new MouseEvent("test",{buttons:1})).buttons}catch(b){xd=!1}let ze=xd,ub=!1;(function(){try{let b=Object.defineProperty({},"passive",{get(){ub=!0}});window.addEventListener("test",null,b);window.removeEventListener("test",null,b)}catch(b){}})();let uc=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const vb=[],wf={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},Ce={button:!0,command:!0,fieldset:!0,
input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};let vc=function(b){var a=b.sourceCapabilities;if(!a||a.firesTouchEvents)if(b.__polymerGesturesHandled={skip:!0},"click"===b.type){a=!1;let f=Oa(b);for(let g=0;g<f.length;g++){if(f[g].nodeType===Node.ELEMENT_NODE)if("label"===f[g].localName)vb.push(f[g]);else if(wf[f[g].localName]){var c=f[g];var d=Array.prototype.slice.call(c.labels||[]);if(!d.length){d=[];var e=c.getRootNode();if(c.id)for(c=e.querySelectorAll(`label[for = ${c.id}]`),
e=0;e<c.length;e++)d.push(c[e])}for(c=0;c<d.length;c++)a=a||-1<vb.indexOf(d[c])}if(f[g]===y.mouse.target)return}a||(b.preventDefault(),b.stopPropagation())}},y={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};document.addEventListener("touchend",function(b){y.mouse.mouseIgnoreJob||tc(!0);y.mouse.target=Oa(b)[0];y.mouse.mouseIgnoreJob=v.debounce(y.mouse.mouseIgnoreJob,G.after(2500),function(){tc();y.mouse.target=null;y.mouse.mouseIgnoreJob=null})},ub?{passive:!0}:!1);
const Oa=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:b=>b.composedPath&&b.composedPath()||[],qa={},X=[];xb({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){Z(this.info)},mousedown:function(b){if(W(b)){var a=M(b),c=this;wc(this.info,function(d){W(d)||(ra("up",a,d),Z(c.info))},function(d){W(d)&&ra("up",a,d);Z(c.info)});ra("down",a,b)}},
touchstart:function(b){ra("down",M(b),b.changedTouches[0],b)},touchend:function(b){ra("up",M(b),b.changedTouches[0],b)}});xb({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(b){2<this.moves.length&&this.moves.shift();this.moves.push(b)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start";this.info.started=
!1;this.info.moves=[];this.info.x=0;this.info.y=0;this.info.prevent=!1;Z(this.info)},mousedown:function(b){if(W(b)){var a=M(b),c=this,d=function(e){let f=e.clientX,g=e.clientY;zc(c.info,f,g)&&(c.info.state=c.info.started?"mouseup"===e.type?"end":"track":"start","start"===c.info.state&&Pa("tap"),c.info.addMove({x:f,y:g}),W(e)||(c.info.state="end",Z(c.info)),a&&zb(c.info,a,e),c.info.started=!0)};wc(this.info,d,function(e){c.info.started&&d(e);Z(c.info)});this.info.x=b.clientX;this.info.y=b.clientY}},
touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchmove:function(b){let a=M(b);b=b.changedTouches[0];let c=b.clientX,d=b.clientY;zc(this.info,c,d)&&("start"===this.info.state&&Pa("tap"),this.info.addMove({x:c,y:d}),zb(this.info,a,b),this.info.state="track",this.info.started=!0)},touchend:function(b){let a=M(b);b=b.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:b.clientX,y:b.clientY}),zb(this.info,a,b))}});xb({name:"tap",
deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN;this.info.y=NaN;this.info.prevent=!1},mousedown:function(b){W(b)&&(this.info.x=b.clientX,this.info.y=b.clientY)},click:function(b){W(b)&&Ac(this.info,b)},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchend:function(b){Ac(this.info,b.changedTouches[0],b)}});const Fa=
D(b=>{class a extends b{_addEventListenerToNode(c,d,e){wb(c,d,e)||super._addEventListenerToNode(c,d,e)}_removeEventListenerFromNode(c,d,e){if(qa[d]){{var f=qa[d];var g=f.deps;f=f.name;let h=c.__polymerGestures;if(h)for(let k=0,l,m;k<g.length;k++)l=g[k],(m=h[l])&&m[f]&&(m[f]=(m[f]||1)-1,m._count=(m._count||1)-1,0===m._count&&c.removeEventListener(l,xc,sc(l)));c.removeEventListener(d,e)}g=!0}else g=!1;g||super._removeEventListenerFromNode(c,d,e)}}return a}),xf=b=>class extends b{static get properties(){return{theme:{type:String,
...
d;break;case "reverse":c.scrollLeft=c.scrollWidth-c.clientWidth-d;break;default:c.scrollLeft=d}else c.scrollLeft=d}}const T=[];let $a;(new MutationObserver(function(){const b=ea();T.forEach(a=>{Ub(a,b)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Ub=function(b,a){a?b.setAttribute("dir",a):b.removeAttribute("dir")},ea=function(){return document.documentElement.getAttribute("dir")},Vb=b=>class extends b{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize();
$a||($a=Tb.detectScrollType())}connectedCallback(){super.connectedCallback();this.hasAttribute("dir")||(this.__subscribe(),Ub(this,ea()))}attributeChangedCallback(a,c,d){super.attributeChangedCallback(a,c,d);if("dir"===a){a=d===ea()&&-1===T.indexOf(this);var e=!d&&c&&-1===T.indexOf(this);c=d!==ea()&&c===ea();a||e?(this.__subscribe(),Ub(this,ea())):c&&this.__subscribe(!1)}}disconnectedCallback(){super.disconnectedCallback();this.__subscribe(!1);this.removeAttribute("dir")}__subscribe(a=!0){a?-1===
T.indexOf(this)&&T.push(this):-1<T.indexOf(this)&&T.splice(T.indexOf(this),1)}__getNormalizedScrollLeft(a){return Tb.getNormalizedScrollLeft($a,this.getAttribute("dir")||"ltr",a)}__setNormalizedScrollLeft(a,c){return Tb.setNormalizedScrollLeft($a,this.getAttribute("dir")||"ltr",a,c)}},Fe=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Qa=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;window.Vaadin=window.Vaadin||{};const yd=function(b,a){if(window.Vaadin.developmentMode)return Bc(b,
a)};if(void 0===window.Vaadin.developmentMode){var Af=window.Vaadin;try{var zd=localStorage.getItem("vaadin.developmentmode.force")?!0:0<=["localhost","127.0.0.1"].indexOf(window.location.hostname)?Qa?!Ee():!De():!1}catch(b){zd=!1}Af.developmentMode=zd}const Ad=function(){if("function"===typeof yd)return yd(Ge)};window.Vaadin||(window.Vaadin={});window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{};window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=
function(){Ad&&Ad()};let Wb;const Bd=new Set,Cd=b=>class extends Vb(b){static finalize(){super.finalize();const {is:a}=this;a&&!Bd.has(a)&&(window.Vaadin.registrations.push(this),Bd.add(a),window.Vaadin.developmentModeCallback&&(Wb=v.debounce(Wb,od,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),S.add(Wb)))}constructor(){super();null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add \x3c!DOCTYPE html\x3e to the HTML document.')}};
...
g=f+g;let k=h&&h[g];k&&(this._removeEventListenerFromNode(e,f,k),h[g]=null)}setScrollDirection(e,f){yc(f||this,c[e]||"auto")}$$(e){return this.root.querySelector(e)}get domHost(){let e=q(this).getRootNode();return e instanceof DocumentFragment?e.host:e}distributeContent(){const e=U(this);window.ShadyDOM&&e.shadowRoot&&ShadyDOM.flush()}getEffectiveChildNodes(){return U(this).getEffectiveChildNodes()}queryDistributedElements(e){return U(this).queryDistributedElements(e)}getEffectiveChildren(){return this.getEffectiveChildNodes().filter(function(e){return e.nodeType===
Node.ELEMENT_NODE})}getEffectiveTextContent(){let e=this.getEffectiveChildNodes(),f=[];for(let g=0,h;h=e[g];g++)h.nodeType!==Node.COMMENT_NODE&&f.push(h.textContent);return f.join("")}queryEffectiveChildren(e){return(e=this.queryDistributedElements(e))&&e[0]}queryAllEffectiveChildren(e){return this.queryDistributedElements(e)}getContentChildNodes(e){return(e=this.root.querySelector(e||"slot"))?U(e).getDistributedNodes():[]}getContentChildren(e){return this.getContentChildNodes(e).filter(function(f){return f.nodeType===
Node.ELEMENT_NODE})}isLightDescendant(e){return this!==e&&q(this).contains(e)&&q(this).getRootNode()===q(e).getRootNode()}isLocalDescendant(e){return this.root===q(e).getRootNode()}scopeSubtree(e,f=!1){return Se(e,f)}getComputedStyleValue(e){return Jf.getComputedStyleValue(this,e)}debounce(e,f,g){this._debouncers=this._debouncers||{};return this._debouncers[e]=v.debounce(this._debouncers[e],0<g?G.after(g):F,f.bind(this))}isDebouncerActive(e){this._debouncers=this._debouncers||{};e=this._debouncers[e];
return!(!e||!e.isActive())}flushDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.flush()}cancelDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.cancel()}async(e,f){return 0<f?G.run(e.bind(this),f):~F.run(e.bind(this))}cancelAsync(e){0>e?F.cancel(~e):G.cancel(e)}create(e,f){e=document.createElement(e);if(f)if(e.setProperties)e.setProperties(f);else for(let g in f)e[g]=f[g];return e}elementMatches(e,f){return Hd.call(f||this,e)}toggleAttribute(e,
...
const Ze=Zb(Hb);let ad=!1;const Lf=Fa(Ld(Ya(HTMLElement)));class Mf extends Lf{static get observedAttributes(){return["mutable-data"]}constructor(){super();if(ba)throw Error("strictTemplatePolicy: dom-bind not allowed");this.__children=this.$=this.root=null}attributeChangedCallback(b,a,c,d){this.mutableData=!0}connectedCallback(){Ib()||(this.style.display="none");this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){q(q(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let b=
0;b<this.__children.length;b++)this.root.appendChild(this.__children[b])}render(){let b;if(!this.__children){b=b||this.querySelector("template");if(!b){let a=new MutationObserver(()=>{if(b=this.querySelector("template"))a.disconnect(),this.render();else throw Error("dom-bind requires a \x3ctemplate\x3e child");});a.observe(this,{childList:!0});return}this.root=this._stampTemplate(b);this.$=this.root.$;this.__children=[];for(let a=this.root.firstChild;a;a=a.nextSibling)this.__children[this.__children.length]=
a;this._enableProperties()}this.__insertChildren();this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}customElements.define("dom-bind",Mf);const Nf=Ld(R);class Md extends Nf{static get is(){return"dom-repeat"}static get template(){return null}static get properties(){return{items:{type:Array},as:{type:String,value:"item"},indexAs:{type:String,value:"index"},itemsIndexAs:{type:String,value:"itemsIndex"},sort:{type:Function,observer:"__sortChanged"},filter:{type:Function,observer:"__filterChanged"},
observe:{type:String,observer:"__observeChanged"},delay:Number,renderedItemCount:{type:Number,notify:!Lb,readOnly:!0},initialCount:{type:Number},targetFramerate:{type:Number,value:20},_targetFrameTime:{type:Number,computed:"__computeFrameTime(targetFramerate)"},notifyDomChange:{type:Boolean},reuseChunkedInstances:{type:Boolean}}}static get observers(){return["__itemsChanged(items.*)"]}constructor(){super();this.__instances=[];this.__renderDebouncer=null;this.__itemsIdxToInstIdx={};this.__renderStartTime=

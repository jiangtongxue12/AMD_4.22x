...
}`),a.fragment.code.add(b.glsl`void readExternalColor(out vec4 externalColor, out int externalColorMixMode) {
externalColor = vExternalColor;
externalColorMixMode = int(vExternalColorMixMode);
}`));0===d.componentData&&(a.vertex.uniforms.add("uExternalColor","vec4"),a.fragment.uniforms.add("uExternalColorMixMode","int"),a.varyings.add("vExternalColor","vec4"),a.vertex.code.add(b.glsl`vec4 forwardExternalColor(out bool castShadows) {

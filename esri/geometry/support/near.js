...
//>>built
define(["exports","../../geometry","../../chunks/vec2","./coordsUtils","../Point"],function(e,q,l,m,n){e.nearestCoordinate=function(a,b){const {spatialReference:p}=b;b=[b.x,b.y];let d=Number.POSITIVE_INFINITY,f=0,g=0;const c=[0,0];a="extent"===a.type?[[[a.xmin,a.ymin],[a.xmin,a.ymax],[a.xmax,a.ymax],[a.xmax,a.ymin],[a.xmin,a.ymin]]]:a.rings;for(const h of a)for(a=0;a<h.length-1;a++){m.projectPointOnLine(c,b,h,a);const k=l.distance(b,c);k<d&&(d=k,f=c[0],g=c[1])}return{coordinate:new n({x:f,y:g,spatialReference:p}),
